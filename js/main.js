/**
 * Hashtag Cleaning - Main JavaScript
        ...
        return `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                <div style="background-color: #6AAFC7; padding: 20px; text-align: center;">
                    ...
                    <p style="color: white; margin: 10px 0 0; opacity: 0.9;">Hashtag Cleaning</p>
                </div>
                ...
                <div style="background-color: #2D3748; padding: 20px; text-align: center;">
                    <p style="color: rgba(255,255,255,0.7); margin: 0; font-size: 14px;">
                        This message was sent from the Hashtag Cleaning website.
                    </p>
                </div>
            </div>
        `;
